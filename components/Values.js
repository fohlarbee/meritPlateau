...
const Values = () => {
  return (
    <div className=" mx-auto py-20">
      <h3 className="font-semibold text-col-blk mt-3 uppercase text-center "> <span className="bg-col-gold mx-4 w-4 h-4 inline-block rounded-full
       "></span>
        our values
      </h3>

      <p className=' font-bodyFont text-col-blk text-xl py-4 my-12 mx-auto text-center w-2/3'>
