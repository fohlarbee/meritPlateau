...
export default function JoinUs() {
  return (
    <section className=" mx-auto">
        <div className="container bg-[url('/assets/support.webp')] bg-no-repeat bg-center py-8 px-16 text-center">         
        ...
        <button className="btn lg:btn-sm bg-[#441752] hover:bg-[#6a3a7a] text-white rounded-lg mr-1 my-8 border-none w-30 lg:w-24 capitalize">join us</button>
        </div>
    </section>
  )
}
